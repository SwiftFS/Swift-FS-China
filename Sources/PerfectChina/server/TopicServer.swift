...
class TopicServer {
    ...
    class func new(title:String,content:String,user_id:Int,user_name:String,category_id:Int)throws -> Int?{
        let now = Utils.now()
    ...
    class func update(topic_id:Int,title:String,content:String,user_id:Int,category_id:Int) throws -> Bool {
    ...
    class func get_my_topic(user_id:Int,id:Int) throws -> [ArticleEntity] {
    ...
    class func delete_topic(user_id:Int,topic_id:Int) throws -> Bool {
        let status: QueryStatus = try pool.execute{ conn in
    ...
    class func get_all_of_user(user_id:Int,page_no:Int,page_size:Int) throws -> [ArticleEntity] {
        var page_no = page_no
    ...
    class func get_all_hot_of_user(user_id:Int,page_no:Int,page_size:Int) throws -> [ArticleEntity] {
        var page_no = page_no
        if page_no < 1 {
            page_no = 1
        }
    ...
    class func get_total_hot_count_of_user(user_id:Int) throws -> Int {
    ...
    class func get(id:Int) throws -> [ArticleEntity]{
        let row:[ArticleEntity] = try pool.execute({ conn in
//          ("update topic set view_num=view_num+1 where id=?", {tonumber(id)})
    ...
    class func get_all(topic_type:String,category:String,page_no:Int,page_size:Int) -> [ArticleEntity]?{
    ...
    class func get_total_count(topic_type:String?,category:String?) throws -> Int {
    ...
    class func reset_last_reply(topic_id:Int,user_id:Int,user_name:String,last_reply_time:Date) throws{
